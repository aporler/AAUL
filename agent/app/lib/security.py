...
from .config import SECURITY_CONFIG_PATH, CERT_PINS_PATH
...
def load_security_config():
    ...
    try:
        ...
        return {"verifyTls": True, "allowSelfSigned": False, "signRequests": True}
...
def get_ssl_context(allow_self_signed=False):
    ...
    if allow_self_signed:
        ...
        # SECURITY: Use CERT_OPTIONAL instead of CERT_NONE to still
        # perform TLS encryption even when certificate is self-signed.
        import warnings
        warnings.warn(
            "allowSelfSigned=True: TLS certificate verification is weakened. "
...
class CertificatePinning:
    ...
    def _save_pins(self):
        ...
        CERT_PINS_PATH.parent.mkdir(parents=True, exist_ok=True)
